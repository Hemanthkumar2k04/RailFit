...
// Import your original screens - they're all still there!
...
import WearAnalysisScreen from './src/screens/WearAnalysisScreen';
import MaintenanceScheduleScreen from './src/screens/MaintenanceScheduleScreen';
import LoginScreen from './src/screens/LoginScreen';

// Simple menu to navigate to your original screens
      ...
      <ScrollView style={styles.menuContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuGrid}>
          {[
            ...
            { name: 'WearAnalysis', icon: '📈', desc: 'Wear Analysis', color: '#84cc16' },
            { name: 'MaintenanceSchedule', icon: '📅', desc: 'Maintenance', color: '#a855f7' }
          ].map((item) => (
            <TouchableOpacity
              key={item.name}
